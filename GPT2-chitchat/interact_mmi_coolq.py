...
def main():
    ...
    def reply():
        ...
        output = generate_reply("这是测试话", args, device, dialogue_model, history, mmi_model, samples_file, tokenizer)
    ...
    # generate_reply("这是测试话", args, device, dialogue_model, history, mmi_model, samples_file, tokenizer)
...
def generate_reply(input_msg, args, device, dialogue_model, history, mmi_model, samples_file, tokenizer) -> str:
    """input_meg: 用户输入
    """
    # 准备flask
    # input_msg = request.form.get('msg', None)
